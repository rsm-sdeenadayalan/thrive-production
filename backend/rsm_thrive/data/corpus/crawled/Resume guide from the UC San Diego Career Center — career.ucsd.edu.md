Source: https://career.ucsd.edu/resources/guides/resume.html
Fetched: 2026-08-24T06:29:21.486Z · fidelity 95.6 (band A) · pipeline rubric/1.2.0

# Resume guide from the UC San Diego Career Center

Review the information below, or [download it as a PDF](https://career.ucsd.edu/_files/career-guides/cc-resume-guide.pdf).

## Example Layout

Note: webpage formatting and paper/file formatting have different requirements. You can use this as a resource along with the available [PDF download of this resume guide](https://career.ucsd.edu/_files/career-guides/cc-resume-guide.pdf).
...
**University of California, San Diego**Expected Month 20XX

_Bachelor of \[Arts or Science\] in \[Major/s\], Concentration or Emphasis_GPA (optional)
...
**Company/Organization**Month/Year – Present

_Position Title_Location (optional)
...
**Project Title**Month/Year – Present
...
**Club/Organization**Month/Year – Present
...
-   Use **keywords and phrases f**rom the job description. This will help the recruiter visualize you in the role and match ATS criteria.
