...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            gsa = t.make_advisor(id="demo-adv-gsa", name="Amber Hanna",
                                 service="advising", email="amber.hanna-demo@ucsd.edu")
            cmc = t.make_advisor(id="demo-adv-cmc", name="Nelitza Morales", service="career",
                                 role="Career Coach", location="CMC office / Zoom",
                                 email="nelitza.morales-demo@ucsd.edu")
            for adv in (gsa, cmc):
                for d in (3, 4, 5):
