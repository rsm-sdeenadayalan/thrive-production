...
from .views import advisors, appointments, assignments, auth, chat, courses, degree, events, health, jobs, overlay, personal, requests, resources, resume, students, tasks
